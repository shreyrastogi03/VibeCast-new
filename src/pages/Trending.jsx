...
const Trending = () => {
  ...
  return (
    <div className="ml-[200px] pt-[4rem] bg-gray-900 text-white min-h-screen flex flex-col">
      {/* Content Wrapper */}
      <div className="flex-grow p-6">
        {/* Heading */}
        <div className="max-w-6xl mx-auto mb-6">
          <h1 className="text-2xl font-bold">Trending Songs</h1>
          <p className="text-gray-400">Discover the latest hits and trending tracks.</p>
        </div>
